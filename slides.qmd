...
Þetta er kynningin á Menti-spurningu #2 — haltu því til haga.
</aside>
...
<p class=”callout”>ChatGPT gerir nákvæmlega það sama — og því skiptir samhengi máli:</p>
...
::: {.fa-card cols=1}
- 1 | Lesa texta | ChatGPT las milljónir bóka, greina og vefsíðna.
- 2 | Finna mynstur | Það lærði hvaða orð koma oft saman.
- 3 | Spá fyrir | Nú getur það klárað setningar og svarað spurningum.
:::
...
## {#perchance data-background-iframe="https://perchance.org/ai-drawing-generator" data-background-interactive=true}

<aside class="notes">Perchance AI Drawing Generator — láttu nemendur prófa að búa til mynd með gervigreind. Tenging við spunagreind: þetta er dæmi um AI sem býr til nýtt efni út frá textalýsingu. Spurðu: hvað virkar? hvað virkar ekki? hvernig þarf að orða lýsinguna?</aside>
