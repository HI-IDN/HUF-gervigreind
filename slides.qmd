...
## {.img-split}
<div class="slide-content">
<span class="kicker">Kafli 1 · Gögn</span>
<h2>Hvað eru gögn?</h2>
...
<div class="slide-content">
<span class="kicker">Kafli 2 · Gagnavísindi</span>
...
::: {.fa-card}
- [brands] spotify | **Spotify Wrapped** | Greinir hvað þú hlustir á mest yfir árið og sýnir þér tölfræði um hlustunarmynstrin þín.
- cloud-sun-rain | Veðurspá | Veðurfræðingar greina gögn frá veðurstöðvum og gervihnöttum til að skilja hvernig veðrið þróast.
- gamepad | Leikjahönnun | Hönnuðir skoða gögn um hvar leikmenn festast og hætta til að finna hvað þarf að bæta.
- [brands] youtube | YouTube Analytics | Myndbandsframleiðendur sjá nákvæmlega hvar áhorfendur hætta að horfa.
- map | Umferðargreining | Skipulagsfræðingar skoða umferðargögn til að skilja hvar þéttast er og hvenær.
- heart-pulse | Heilbrigðisþjónusta | Læknar greina sjúkdómsgögn til að skilja hvaða meðferð virkar best fyrir hvern sjúkling.
- [brands] amazon | Netverslun | Verslanir greina kaupmynstur til að skilja hvað selst best og hvenær tilboð virka.
- fish | Fiskvinnsla | Gæðastjórar skoða framleiðslugögn til að finna hvar í ferlinu sóun verður til.
- graduation-cap | Skóli | Kennarar skoða einkunnir og ástundun til að skilja hvaða nemendur þurfa á aðstoð að halda.
:::
...
<div class="slide-content">
<span class="kicker">Kafli 3 · Gervigreind</span>
...
- microphone | Hljóðgreining | Siri, Alexa og raddskráning þekkja töluð orð og breyta þeim í texta.
- robot | Sjálfvirkni | Tölvur læra með því að prófa og fá umbun með styrkingarnámi — eins og sjálfkeyrandi bílar og leikjaAI.
- thumbs-up | Ráðleggingakerfi | Netflix, Spotify og Amazon mæla með efni út frá því sem þú hefur séð, hlustað og keypt.
...
:::{.fa-card}
- [brands] spotify | **Discover Weekly** | Líkanið lærir smekk þinn og velur sjálfkrafa 30 lög sem þér líkar vel — án þess að þú biðjir um það.
- cloud-sun-rain | Veðurspá | Gervigreindarlíkan spáir sjálfkrafa nákvæmlega fyrir um veðrið 10 daga fram í tímann.
- gamepad | Leikjahönnun | Gervigreind aðlagar erfiðleikastig sjálfkrafa í rauntíma eftir því hvernig þér gengur.
- [brands] youtube | YouTube tillögur | Líkanið velur sjálfkrafa næsta myndband til að halda þér á síðunni eins lengi og mögulegt er.
- map | Google Maps | Spáir fyrir umferðartafir og reiknar bestu leið sjálfkrafa — uppfærst á nokkurra sekúndna fresti.
- heart-pulse | Heilbrigðisþjónusta | AI-líkan þekkir sjúkdóma úr röntgenmyndum — oft nákvæmar og hraðar en læknar gera það.
- [brands] amazon | Amazon tillögur | „Viðskiptavinir sem keyptu þetta keyptu líka…" — líkanið lærir kaupmynstur og mælir sjálfkrafa með.
- fish | Fiskvinnsla | Vél lærir af framleiðslugögnum og skerar fiskinn sjálfkrafa þannig að minnst fari til spillis.
- graduation-cap | Nám | Gervigreindartól eins og ChatGPT geta veitt nemendum persónulegt umhverfi til að spyrja spurninga, fá ítarlegri skýringar og ræða efnið á sínum hraða.
:::
...
<div class="slide-content">
<span class="kicker">Kafli 4 · Spunagreind</span>
...
:::
<p class="tool-row-label">Vinsæl gervigreindartól:</p>
<div class="tool-row">
